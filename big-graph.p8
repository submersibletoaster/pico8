...
function camchase(f,c)
 ...
 if c[1] <0 then
   c[1]=0
   --printh("clamp-x")
 elseif c[1] > 3*128 then
   c[1]=3*128
 end
 if c[2] <0 then
   c[2]=0
 elseif c[2] > 1*128 then
   c[2]=1*128
   --printh("clamp-y")
 end
...
function spritedots(s,x,y,sx,sy,ipal)
 sx=sx or 1
 sy=sy or 1
 ipal=ipal or {}
 local px=(s%16)*8
...
pl.new=function(cx,cy)
  ...
  t.anim_up={88,88,88,89,89,90,90,90,89,89}
  t.anim=t.anim_walk
  t.flp=false
  local pos=cell2mxy(cx,cy)
  t.pos=pos
...

